...
static void sdcc_gpio_init(void)
{
	...
	if (gpio_request(GPIO_MMC_CD_N, "sdc2_status_irq"))
		...
		rc = gpio_tlmm_config(GPIO_CFG(GPIO_MMC_CD_N, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	...
	if (gpio_request(GPIO_MMC_CD_COVER, "sdc2_status_irq"))
		pr_err("failed to request gpio sdc2_status_irq\n");
		rc = gpio_tlmm_config(GPIO_CFG(GPIO_MMC_CD_COVER, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL,GPIO_CFG_2MA), GPIO_CFG_ENABLE);
